...
export function LoadingCard({
  ...
  return (
    ...
    >
      {title && (
        <Box className={classes.loadingTitle} fontWeight='fontWeightBold'>
          {title}
        </Box>
      )}
      {[ExchangeStep.approving, ExchangeStep.approved, ExchangeStep.exchanging].includes(
        exchangeStep,
      ) && <Ellipsis />}
      ...
      {[ExchangeStep.approved, ExchangeStep.completed, ExchangeStep.error].includes(
        exchangeStep,
      ) && <SubmitButton label={buttonText} clickHandler={buttonHandler} />}
    </Box>
  );
}
