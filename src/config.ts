...
export const assetPairs: { [key in Wrapper]: Asset[][] } = {
  ...
  [Wrapper.unbutton]: [[Asset.AMPL, Asset.WAMPL]],
};
...
const config: Config = {
  [Network.Mainnet]: {
    ...
    assets: {
      ...
      [Asset.bETH]: new Token(
        1,
        '0x125c7b36bea62ba3266257521667154446412921',
        18,
        'bETH',
        'Button ETH',
      ),
      [Asset.bBTC]: new Token(
        1,
        '0x69d4d3629e1aFEE0C4E75B6B345B482979A77112',
        8,
        'bBTC',
        'Button BTC',
      ),
      [Asset.ubAAMPL]: new Token(
        1,
        '0xF03387d8d0FF326ab586A58E0ab4121d106147DF',
        18,
        'ubAAMPL',
        'Unbuttoned AAVE AMPL',
      ),
      [Asset.WAMPL]: new Token(
        1,
  ...
  [Network.Kovan]: {
    ...
    assets: {
      ...
      [Asset.bETH]: new Token(
        42,
        '0x80ee392d7f9fe19ccfdbc5365983e7fc4c68ca4e',
        18,
        'bETH',
        'Button ETH',
      ),
      [Asset.bBTC]: new Token(
        42,
        '0x414fec543d85f2ef95a98221ec214cec745862e0',
        8,
        'bBTC',
        'Button BTC',
      ),
      [Asset.ubAMPL]: new Token(
        42,
        '0xebb66682be59c7de222afd7e884c065b5f1ca9ca',
        18,
        'ubAMPL',
        'Unbuttoned AMPL',
      ),
...
Object.values(config).forEach((networkConfig: NetworkConfig) => {
  Object.entries(assetPairs).forEach(([key, value]) => {
    ...
    const tokenPairs = value
      .map((assetList: Asset[]) => assetList.map((asset) => networkConfig.assets[asset]))
      .filter((tokenpair: (Token | undefined)[]) =>
        tokenpair.every((token) => token !== undefined),
      ) as [Token, Token][];
